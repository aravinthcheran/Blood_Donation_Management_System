            ...
            <div className='bg-white p-3 rounded w-75'>
                ...
                <form className="row g-3">
                    ...
                    <div className="col-md-12 text-center">
                        <button type='submit' className='btn btn-primary w-50 rounded-0 text-decoration-none'><Link to='/pages/patient'>Login</Link></button>
                    </div>
                    <div className="col-md-12 text-center">
                        <p>Don't have an account? <Link to='/pages/SignUpPatient' className='text-decoration-none'>Sign Up</Link></p>
                    </div>
                </form>
            </div>
        </div>
