            ...
            <div className='bg-white p-3 rounded w-75'>
                ...
                <form onSubmit={handleSubmit} className="row g-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <input type='text' placeholder='Enter Contact' name='contact' className='form-control rounded-0' onChange={handleChange} value={values.contact}/>
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-md-6">
                        <label htmlFor='bloodType' className='form-label'><strong>Blood Type</strong></label>
                        <input type='text' placeholder='Enter Blood Type' name='bloodType' className='form-control rounded-0' onChange={handleChange} value={values.bloodType}/>
                    </div>
                    <div className="col-md-6">
                        <label htmlFor='weight' className='form-label'><strong>Weight</strong></label>
                        <input type='number' placeholder='Enter Weight' name='weight' className='form-control rounded-0' onChange={handleChange} value={values.weight}/>
                    </div>
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        <Link to='/pages/LoginPatient' className='btn btn-default border w-50 bg-light rounded-0 text-decoration-none'>Login</Link>    
                    </div>
                </form>
            </div>
        </div>
